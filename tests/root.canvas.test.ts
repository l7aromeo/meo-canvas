...
let Canvas: typeof import('meo-skia-canvas').Canvas
let FontLibrary: typeof import('meo-skia-canvas').FontLibrary
...
let skiaCanvasMocks: typeof import('@/__mocks__/meo-skia-canvas.js').__mocks__
...
describe('RootNode', () => {
  beforeEach(async () => {
    ...
    skiaCanvasMocks = (await import('@/__mocks__/meo-skia-canvas.js')).__mocks__
    ...
    const skiaCanvasModule = await import('meo-skia-canvas')
