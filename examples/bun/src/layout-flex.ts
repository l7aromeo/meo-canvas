/**
 * Flexbox: every direction, both wraps, and each way of distributing a line, as
 * rows of coloured blocks, so a block that fails to move shows against its neighbours.
 */
