...
const common = {
  ...
  external: id => {
    return ['phyron-skia-canvas', 'yoga-layout', 'lodash-es', 'tinycolor2', 'file-type', 'node:fs', 'path', 'node:worker_threads'].includes(id) || id.startsWith('tslib') || id.startsWith('comlink')
  },
}
